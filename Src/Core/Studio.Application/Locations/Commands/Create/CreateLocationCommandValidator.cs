namespace Studio.Application.Locations.Commands.Create
{
    ...
    public class CreateLocationCommandValidator : AbstractValidator<CreateLocationCommand>
    {
        public CreateLocationCommandValidator()
        {
            ...
            RuleFor(l => l.StartDay).NotEmpty().Must(this.BeValidDayOfWeek).WithMessage("Invalid StartDay");
            RuleFor(l => l.EndDay).NotEmpty().Must(this.BeValidDayOfWeek).WithMessage("Invalid EndDay");
            RuleFor(l => l.StartHour).NotEmpty().Must(this.BeValidHour).WithMessage("Invalid StartHour");
            RuleFor(l => l.EndHour).NotEmpty().Must(this.BeValidHour).WithMessage("Invalid EndHour");
